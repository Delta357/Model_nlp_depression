...
| Dataset               | Link                                                |
| ----------------- | ---------------------------------------------------------------- |
| Depression - Rural areas |[Projeto - Notebook]()|
| Depression Twitter Dataset + Feature Extraction |[Projeto - Notebook]()|
| Depression Social media|[Projeto - Notebook]()|
| Depression Negative Posting on Social Media|[Projeto - Notebook]()|
| Depression Student |[Projeto - Notebook]()|
| Stress Analysis |[Projeto - Notebook]()|
